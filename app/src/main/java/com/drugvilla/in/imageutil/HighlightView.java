...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = ResourcesCompat.getDrawable(mContext.getResources(), R.drawable.camera_crop_width, null);


       /*mResizeDrawableWidth=
        resources.getDrawable(R.drawable.camera_crop_width);*/
        mResizeDrawableHeight = ResourcesCompat.getDrawable(mContext.getResources(), R.drawable.camera_crop_height, null);
        /*mResizeDrawableHeight =
                resources.getDrawable(R.drawable.camera_crop_height);*/
    //    mResizeDrawableDiagonal = ResourcesCompat.getDrawable(mContext.getResources(), R.drawable.indicator_autocrop, null);
